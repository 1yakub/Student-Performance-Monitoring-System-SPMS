...
<body>
  ...
  <form action="createCourseOutlineConfig.php" method="post">
    ...
    <div class="course_description">
      ...
      <textarea name="courseDescription" class="text-area" cols="30" rows="10"
    ...
    <div class="course_objective">
      ...
      <textarea name="courseObjective" class="text-area" cols="30" rows="10"
        placeholder="Enter Course Objective"></textarea>
    </div>
    ...
    <div class="non_discremination_policy">
      ...
      <p>The course and University policy prohibit discrimination based on race, color, religion, sex, marital or
        parental
        status, national origin or ancestry, age, mental or physical disability, sexual orientation, military status. If
        you
    ...
    <div class="course_content">
      ...
      <textarea name="courseContent" class="text-area" cols="30" rows="10"
    ...
    <div class="course_learning_outcome_matrix">
      ...
      <table>
        ...
        <th colspan="8">*Bloom's Learning Level: Numbers signifies the Level of Bloom's skills.<br> **CLO – PLO
          Correlation: 3 – high, 2 – medium, 1- low</th>
        </tr>
    ...
    <div class="assessment_and_evaluation">
      ...
      <table>
        ...
        <tr>
          <td rowspan="3"><input type="text" class="course-title" placeholder="Enter Assessment Type"
              name="assessmentType1"></td>
    ...
    <p style="text-align:center; font-weight:bold;">The following chart will be followed for grading. Please note that
    ...
    <div class="referance_book">
      ...
      <textarea name="refMaterials" class="text-area" cols="30" rows="10"
        placeholder="Enter Reference Materials"></textarea>
    </div>
