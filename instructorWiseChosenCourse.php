  ...
  <div class="background">
    ...
    <div class="row1" style="display:flex;justify-content:center;">
      ...
      <form method="POST">
        ...
        <select name="year" class="select" style="margin-left:0px;">
        ...
        <input style="background:#00BFFF;
              ...
              margin-left:5px;
              height: 36px;
              width: 100px;" type="submit" name="submitCourseCode" value="Submit" />
      </form>
    </div>

    <div style="height:50px;padding-left:43%;margin-top:15px;">
      <button onclick="viewInstructorWiseChosenCourse()"
