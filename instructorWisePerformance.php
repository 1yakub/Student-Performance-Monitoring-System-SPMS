...
<body>
  ...
  <div class="background">
    ...
    <div class="row1">
      <form method="POST">
        ...
        <input style="background:#00BFFF;
              ...
              margin-left:5px;
              height: 36px;
              width: 100px;" type="submit" name="submitInstructorName" value="Submit" />
    ...
    <div style="height:50px;display:flex;justify-content:space-around;">
      ...
      <select name="courseInstructor1" class="select" style="margin-left:0px;width:250px;height:100%;margin-top:0px;">
      ...
      <select name="courseInstructor2" class="select" style="margin-left:0px;width:250px;height:100%;margin-top:0px;">
        <option disabled selected>Course Instructor</option>
        <option value="4275">Tahsin F.Ara Nayna</option>
        <option value="4361">Shovasis Kumar Biswas</option>
        <option value="4351">Nabila Rahman Nodi</option>
      ...
      <select name="courseInstructor3" class="select" style="margin-left:0px;width:250px;height:100%;margin-top:0px;">
        <option disabled selected>Course Instructor</option>
        <option value="4275">Tahsin F.Ara Nayna</option>
        <option value="4361">Shovasis Kumar Biswas</option>
        <option value="4351">Nabila Rahman Nodi</option>
    ...
    <div style="height:50px;padding-left:43%;margin-top:15px;">
      <button onclick="viewInstructorWise()"
        style="height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#00BFFF;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
        view</button>
    </div>
